...
| [[Spatiotemporal Analysis of RGB-D-T Facial Images for Multimodal Pain Level.pdf]]（2015-54）                                                                                    | 结合RGB、深度、热成像，利用时空滤波器提取像素释放能量                                                                              |                                             |
# 公开数据库
...
- PD主要有两个方面进行创新：特征提取和学习方式。面部位置检测如今应该比较成熟，不好创新。